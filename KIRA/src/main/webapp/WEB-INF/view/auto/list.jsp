...
<div class="ui menu" style="border-radius: 0;margin-top: 0px;">
    <a class=" red item" href="/auto/add/${aut.urlName}">
        <i class="add icon"></i> New ${aut.name}
    </a>
</div>
<div id="container">
    <h2 class="ui header">
            ...
            <table class="ui table segment">
                ...
                <c:forEach var="item" items="${list}">
                    <tr>
                        ...
                        <td>
                            <a href="/auto/edit/${aut.urlName}/${id}">Edit</a> |
                            <a href="/auto/detail/${aut.urlName}/${id}">Detail</a> |
                            <a href="/auto/delete/${aut.urlName}/${id}">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
